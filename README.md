...
```bibtex
@software{nudt_sphereface_2024,
  title = {SPHEREFACE Face Recognition Attack & Defense System},
  author = {NUDT Research Team},
  year = {2024},
  url = {https://github.com/your-repo/nudt_sphereface}
}
```
...
- SPHEREFACE authors for the face recognition model
